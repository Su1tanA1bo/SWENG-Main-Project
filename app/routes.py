...
#function for handling webapp home page. Currently contains temporary posts passed by default, will be updated later
@app.route('/')
@app.route('/index')
@login_required
def index():
...
def user(username):
    ...
    #Empty form passed for gaining or losing new followers
    form = EmptyForm()
